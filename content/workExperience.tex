...
{\cvlist{
		...
		for customers such as EPLAN, GMB, Ross Controls
...
{\cvlist{
		\item Integration of the GMB (SCS) spot welding maintenance team to
		the ERP Odoo system, in the process included integrations such as
		spot control and automated QRCode reading of the equipment with
		the ERP
		\item Automation from scratch of a painting line with KTL technology
		at Randon Implementos (Caxias do Sul), automation included elements such as Elipse
...
{\cvlist{
		...
		together
		\item I coordinated a massive migration from GMB (SCS) to GMB (SJC) plants
...
{\cvlist{
		...
		Alergan (pharmacy), Taboca (mining company), Mercedez Bens (final assembly), GMB (bodyshop), Coral (chemical), Cofap (parts) and others, demand that required maturity and procedures within the best PMI practices
		\item Official representative of Rockwell do Brasil in projects and
		assistance
	}}
{\cvlist {
		\item Various models of PLC SCADA (LADDER, Block Instruction, STL), HMI,
...
{\cvlist{
		\item Electrical projects for various factory standards such as GMB, VWB,
